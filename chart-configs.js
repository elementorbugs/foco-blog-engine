...
module.exports = {
  ...
  // ── SPOKE: Why You Keep Abandoning ADHD Planner Apps ───────────────────
  // NOTE: this post uses CUSTOM light-native infographics (not the K.* dark-card
  // kit) because the post renders light and light-articles.css forces <strong>
  // dark, which washed out the kit's timeline labels. Classes: foco-loopfig /
  // foco-traitfig (div/span only, no p/strong/h*, so no forced overrides apply).
  // This post is hand-tuned (curated Pexels + Reddit card too) — do NOT blindly
  // re-run create-post.js on it; use scripts/inject helper to refresh charts.
  'why-you-keep-abandoning-adhd-planner-apps': {
    postId: 3332,
    file: 'post-why-you-keep-abandoning-adhd-planner-apps.html',
    charts: [
      { pos: 4, html: `<!-- wp:html --><figure class="foco-loopfig"><style>.foco-loopfig{margin:34px 0;background:#fff;border:1px solid #E7DFF7;border-radius:20px;padding:30px 30px;box-shadow:0 24px 50px -30px rgba(45,18,87,.45);box-sizing:border-box;max-width:100%}.foco-loopfig *{box-sizing:border-box}.foco-loopfig .lf-t{font-size:13px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#7C3AED;margin:0 0 26px}.foco-loopfig .lf-steps{display:grid;grid-template-columns:repeat(5,1fr);gap:8px;position:relative}.foco-loopfig .lf-steps::before{content:"";position:absolute;top:27px;left:10%;right:10%;height:2px;background:linear-gradient(90deg,#C9B8FF 0%,#C9B8FF 70%,#F4C39A 100%);z-index:0}.foco-loopfig .lf-step{position:relative;z-index:1;display:flex;flex-direction:column;align-items:center;text-align:center;gap:12px}.foco-loopfig .lf-num{width:54px;height:54px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:19px;font-weight:800;color:#fff;background:linear-gradient(135deg,#7C3AED,#A78BFA);box-shadow:0 12px 24px -8px rgba(124,58,237,.65);border:3px solid #fff}.foco-loopfig .lf-step:last-child .lf-num{background:linear-gradient(135deg,#FB923C,#F97316);box-shadow:0 12px 24px -8px rgba(249,115,22,.6)}.foco-loopfig .lf-lbl{font-size:15px;font-weight:800;color:#160F22;line-height:1.25}.foco-loopfig .lf-sub{font-size:12.5px;color:#6E6684;line-height:1.45;margin-top:4px}.foco-loopfig .lf-loop{margin-top:24px;display:flex;align-items:center;justify-content:center;gap:9px;background:#FBF2EA;border:1px solid #F3D6BE;border-radius:14px;padding:13px 18px;color:#B4541A;font-weight:700;font-size:14.5px;text-align:center}.foco-loopfig .lf-loop b{font-size:17px;line-height:1}.foco-loopfig .lf-cap{margin:16px 2px 0;font-size:13.5px;color:#6E6684;line-height:1.55}@media(max-width:600px){.foco-loopfig{padding:22px 18px}.foco-loopfig .lf-steps{grid-template-columns:1fr;gap:0}.foco-loopfig .lf-steps::before{left:26px;right:auto;top:8%;bottom:8%;width:2px;height:auto;background:linear-gradient(180deg,#C9B8FF,#F4C39A)}.foco-loopfig .lf-step{flex-direction:row;text-align:left;gap:16px;padding:9px 0}.foco-loopfig .lf-num{width:42px;height:42px;font-size:16px;flex-shrink:0}.foco-loopfig .lf-lbl{font-size:15px}}</style><div class="lf-t">The ADHD App-Abandonment Loop</div><div class="lf-steps"><div class="lf-step"><div class="lf-num">1</div><div class="lf-txt"><div class="lf-lbl">Download &amp; hype</div><div class="lf-sub">New app, dopamine of possibility</div></div></div><div class="lf-step"><div class="lf-num">2</div><div class="lf-txt"><div class="lf-lbl">Over-setup</div><div class="lf-sub">Hours perfecting the system</div></div></div><div class="lf-step"><div class="lf-num">3</div><div class="lf-txt"><div class="lf-lbl">Three good days</div><div class="lf-sub">It actually gets used</div></div></div><div class="lf-step"><div class="lf-num">4</div><div class="lf-txt"><div class="lf-lbl">Novelty gone</div><div class="lf-sub">Upkeep now feels like work</div></div></div><div class="lf-step"><div class="lf-num">5</div><div class="lf-txt"><div class="lf-lbl">Guilt &amp; quit</div><div class="lf-sub">Overdue pile, app avoided</div></div></div></div><div class="lf-loop"><b>&#8635;</b> And the cycle restarts, no willpower failure required</div><div class="lf-cap">Novelty fuels the start; daily upkeep fuels the drop-off. That is the trap, not a character flaw.</div></figure><!-- /wp:html -->` },
      { pos: 9, html: `<!-- wp:html --><figure class="foco-traitfig"><style>.foco-traitfig{margin:34px 0;background:#fff;border:1px solid #E7DFF7;border-radius:20px;padding:30px 30px;box-shadow:0 24px 50px -30px rgba(45,18,87,.45);box-sizing:border-box;max-width:100%}.foco-traitfig *{box-sizing:border-box}.foco-traitfig .tf-t{font-size:13px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#7C3AED;margin:0 0 6px}.foco-traitfig .tf-lead{font-size:14px;color:#6E6684;margin:0 0 22px;line-height:1.5}.foco-traitfig .tf-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.foco-traitfig .tf-card{display:flex;gap:15px;align-items:flex-start;padding:18px 18px;background:#FBF9FE;border:1px solid #ECE3FA;border-radius:14px}.foco-traitfig .tf-ic{width:46px;height:46px;flex-shrink:0;border-radius:13px;background:linear-gradient(135deg,#F1EAFC,#E2D4FB);display:flex;align-items:center;justify-content:center;font-size:23px}.foco-traitfig .tf-lbl{font-size:16px;font-weight:800;color:#160F22;margin-bottom:4px;line-height:1.2}.foco-traitfig .tf-sub{font-size:13.5px;color:#544B69;line-height:1.5}@media(max-width:600px){.foco-traitfig{padding:22px 18px}.foco-traitfig .tf-grid{grid-template-columns:1fr}}</style><div class="tf-t">What Makes an ADHD App Actually Stick</div><div class="tf-lead">The tools that survive past day three tend to share the same four traits.</div><div class="tf-grid"><div class="tf-card"><div class="tf-ic">&#127919;</div><div class="tf-bd"><div class="tf-lbl">One step at a time</div><div class="tf-sub">Shows the next action, not the whole backlog</div></div></div><div class="tf-card"><div class="tf-ic">&#127811;</div><div class="tf-bd"><div class="tf-lbl">Near-zero upkeep</div><div class="tf-sub">Nothing to maintain, nothing to fall behind on</div></div></div><div class="tf-card"><div class="tf-ic">&#128524;</div><div class="tf-bd"><div class="tf-lbl">No guilt scoreboard</div><div class="tf-sub">No growing pile of overdue red to avoid</div></div></div><div class="tf-card"><div class="tf-ic">&#129309;</div><div class="tf-bd"><div class="tf-lbl">Help to start</div><div class="tf-sub">Support at the moment of beginning, not just storage</div></div></div></div></figure><!-- /wp:html -->` },
    ],
  },
